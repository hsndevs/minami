...
function minami_post_thumbnail()
{
...
add_action('minami_post_thumbnail', 'minami_post_thumbnail');
...
function loop_category_posts($child_category, $child_category_posts)
{
	...
	if (count($child_category_posts) < 1) {
		...
		foreach ($child_category_posts as $post) {
			...
			$post_thumbnail = has_post_thumbnail($post) ? get_the_post_thumbnail($post, 'full', array('style' => '')) : '<span style="font-size: 1.5em; color: #333;">Minami</span>';
...
{
	$labels = array(
		'name'               => _x('Case Studies', 'Post type general name', 'minami'),
		'singular_name'      => _x('Case Study', 'Post type singular name', 'minami'),
		'menu_name'          => _x('Case Studies', 'Admin Menu text', 'minami'),
		'name_admin_bar'     => _x('New Case Study', 'Add New on Toolbar', 'minami'),
		'add_new'            => _x('Add New', 'case study', 'minami'),
		'add_new_item'       => __('Add New Case Study', 'minami'),
		'edit_item'          => __('Edit Case Study', 'minami'),
		'new_item'           => __('New Case Study', 'minami'),
		'view_item'          => __('View Case Study', 'minami'),
		'all_items'          => __('All Case Studies', 'minami'),
		'search_items'       => __('Search Case Studies', 'minami'),
		'not_found'          => __('No case studies found.', 'minami'),
		'not_found_in_trash' => __('No case studies found in Trash.', 'minami'),
	);
...
function render_testimonials_tabs($attributes, $content)
{
	...
	// Loop through parsed blocks and filter for 'minami/testimonial-item'
	foreach ($parsed_blocks as $block) {
		if ('minami/testimonial-item' === $block['blockName'] && ! empty($block['attrs']['imageUrl'])) {
	...
	ob_start();
?>
	<div class="minami-testimonials-tabs">
		<!-- Tab Navigation -->
		<div class="minami-testimonials-tab-nav">
		...
		<!-- Tab Content -->
		<div class="minami-testimonials-tab-content">
